<form class="form" method="post" action="<?=SERVER_SELF;?>">
    ...
    <div class="form-group">
        ...
        <input name="name" id="name" type="text" class="form-control" value="<?=$mailer->isValidated ? '' : $mailer->name?>" data-required="true">
    </div>
    <div class="form-group">
        <label for="email">Email</label>
        <input name="email" id="email" type="text" class="form-control" value="<?=$mailer->isValidated ? '' : $mailer->email?>" data-required="true">
    </div>
    <div class="form-group">
